    ...
    <div class="container">
        <form style="margin-top: 5%;" class="ingresarGrafo" method="get">
            ...
            <div class="form-group" style="margin-top: 2%;">
                ...
                <input type="text" class="form-control" name="verticesGrafoDirigido" id="verticesGrafoDirigido" title="Debe ingresar los vértices como el ejemplo: a,b,c" pattern="^[a-zA-Z0-9]+(,[a-zA-Z0-9]+)*$" placeholder="Ingrese los vértices separados por comas. (Ej: a,b,c,d)" autocomplete="off" value="<?php echo htmlspecialchars($_GET['verticesGrafoDirigido'] ?? '', ENT_QUOTES); ?>" required>
            </div>
            @php
                if(isset($_GET['verticesGrafoDirigido']) && is_string('verticesGrafoDirigido'))
                {
                    $verticesGrafoDirigido = $_GET['verticesGrafoDirigido'];
                    $GrafoDirigido = new GrafoSimple($verticesGrafoDirigido);
                }
            @endphp
                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="input-group" style="margin-top: 2%;">
                            ...
                            @foreach($GrafoDirigido->get_vertices() as $vertice)
        ...
        <a style="text-decoration: none;" href="{{route('procesando-grafo') . '?t=' . base64_encode($texto_de_adyacencias) . '&v=' . base64_encode($verticesGrafoDirigido)}}">
